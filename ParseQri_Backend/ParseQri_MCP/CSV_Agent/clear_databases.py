...
def clear_postgres_tables(user_id=None, db_url="postgresql://postgres:root@localhost:5432/parseqri", schema="public"):
    """
...
def main():
    ...
    parser.add_argument('--db-url', type=str, default="postgresql://postgres:root@localhost:5432/parseqri", 
